...
const projectsDB = {
    ...
    '2': {
        ...
        description: "An analytical deep dive into predictive maintenance using NASA's turbofan engine degradation simulation datasets. This project leverages supervised learning algorithms to accurately predict Remaining Useful Life (RUL) of critical industrial components, formatted rigorously in LaTeX.",
...
const ProjectDetail = () => {
  ...
  useEffect(() => {
    // Ensuring scroll resets to top when navigating to a new page
    window.scrollTo(0, 0);
